<%@ Page Language="C#" MasterPageFile="../usermaster.Master" AutoEventWireup="true" CodeBehind="IsssueEquipment.aspx.cs" Inherits="LURecCenterWeb.UI.forms.IsssueEquipment" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%--   <asp:LinkButton runat="server" ID="adduser" OnClick="Link_Click" Text="Add user"> </asp:LinkButton>--%>
</asp:Content>
